            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ $order->customer->name }}
                        @if($order->promo)
                            <span class="badge" style="background-color:#dcfce7; color:#15803d; border:1px solid #bbf7d0; font-size:10px; margin-left:6px; padding:2px 6px; text-transform:none;">
                                🏷️ {{ $order->promo->code }} (-Rp {{ number_format($order->discount_amount, 0, ',', '.') }})
                            </span>
                        @endif
                    </td>
                    ...
                    <td style="text-align:center">
                        <div style="display:flex;gap:6px;justify-content:center">
                            ...
                            <a href="{{ route('payments.create', ['order_id' => $order->id]) }}" class="btn btn-success" style="padding:6px 12px;font-size:12px">💵 Bayar</a>
                            @endif
