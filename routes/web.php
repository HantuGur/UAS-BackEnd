...
Route::middleware('admin.auth')->prefix('admin')->group(function () {
    ...
    Route::get('orders/{id}/qris', [OrderController::class, 'showQris'])->name('admin.orders.qris');
    Route::post('orders/{id}/qris/confirm', [OrderController::class, 'confirmQris'])->name('admin.orders.qris.confirm');
